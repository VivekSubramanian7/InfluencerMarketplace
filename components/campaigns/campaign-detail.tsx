...
async function CreatorPanel({
  ...
  const sectionMt = compact ? "mt-6" : "mt-10";
  ...
  if (mine) {
    return (
      <section className={`${sectionMt} max-w-xl rounded-xl border p-5`}>
  ...
  if (!open) {
    return (
      <p className={`${sectionMt} rounded-xl border border-dashed p-6 text-sm text-muted-foreground`}>
